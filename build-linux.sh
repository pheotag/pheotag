...
function rpm_spec {
	...
	echo "if [ ! -f /usr/bin/pheotag ] ; then ln -s /usr/lib/pheotag/pheotag /usr/bin/pheotag ; fi" >> build/specfile.spec
	echo "" >> build/specfile.spec
	echo "%postun" >> build/specfile.spec
	echo "if [ -f /usr/bin/pheotag ] ; then rm -f /usr/bin/pheotag ; fi" >> build/specfile.spec
}
